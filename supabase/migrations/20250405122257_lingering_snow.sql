/*
  # Add Motivational Quote Competition System

  1. New Tables
    - `quote_themes`
      - Stores weekly themes for quote submissions
    - `quote_entries`
      - Stores user quote submissions for the competition
    - `quote_votes`
      - Tracks user votes on quotes
    - `quote_winners`
      - Records weekly winners and their rewards

  2. Changes
    - Add functions for vote counting and winner selection
    - Add policies for data access and submission rules
    - Add triggers for XP and coin rewards
